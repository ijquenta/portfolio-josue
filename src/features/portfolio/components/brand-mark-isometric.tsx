...
export function BrandMarkIsometric() {
  const id = useId()
  const ids = {
    facePattern: `brand-face-pattern-${id}`,
    faceFill: `brand-face-fill-${id}`,
  }
    ...
    >
      ...
      <g className="fill-background" fillRule="evenodd" clipRule="evenodd">
        <motion.path
          variants={{
            normal: {
              d: "M0 0 L-28 16 L-28 -16 L0 -32 ZM0 0 L84 48 L84 16 L0 -32 ZM56 32 L-56 96 L-56 64 L56 0 ZM56 32 L84 48 L84 16 L56 0 ZM-84 48 L-112 64 L-112 32 L-84 16 ZM-84 48 L0 96 L0 64 L-84 16 ZM-28 16 L-56 32 L-56 0 L-28 -16 ZM-28 16 L0 32 L0 0 L-28 -16 Z",
            },
            pressed: {
              d: "M0 0 L-28 16 L-28 0 L0 -16 ZM0 0 L84 48 L84 32 L0 -16 ZM56 32 L-56 96 L-56 80 L56 16 ZM56 32 L84 48 L84 32 L56 16 ZM-84 48 L-112 64 L-112 48 L-84 32 ZM-84 48 L0 96 L0 80 L-84 32 ZM-28 16 L-56 32 L-56 16 L-28 0 ZM-28 16 L0 32 L0 16 L-28 0 Z",
            },
          }}
          transition={transition}
        />
        ...
        <motion.path
          variants={{
            normal: {
              d: "M112 64 L84 80 L84 48 L112 32 ZM112 64 L196 112 L196 80 L112 32 ZM112 64 L0 128 L0 96 L112 32 ZM112 64 L140 80 L140 48 L112 32 ZM168 96 L56 160 L56 128 L168 64 ZM168 96 L196 112 L196 80 L168 64 ZM28 112 L0 128 L0 96 L28 80 ZM28 112 L112 160 L112 128 L28 80 Z",
            },
            pressed: {
              d: "M112 64 L84 80 L84 64 L112 48 ZM112 64 L196 112 L196 96 L112 48 ZM112 64 L0 128 L0 112 L112 48 ZM112 64 L140 80 L140 64 L112 48 ZM168 96 L56 160 L56 144 L168 80 ZM168 96 L196 112 L196 96 L168 80 ZM28 112 L0 128 L0 112 L28 96 ZM28 112 L112 160 L112 144 L28 96 Z",
            },
          }}
          transition={transition}
        />
        ...
        <motion.path
          variants={{
            normal: {
              d: "M224 128 L196 144 L196 112 L224 96 ZM224 128 L308 176 L308 144 L224 96 ZM224 128 L168 160 L168 128 L224 96 ZM224 128 L252 144 L252 112 L224 96 ZM196 144 L168 160 L168 128 L196 112 ZM196 144 L280 192 L280 160 L196 112 ZM224 192 L168 224 L168 192 L224 160 ZM224 192 L252 208 L252 176 L224 160 ZM140 176 L112 192 L112 160 L140 144 ZM140 176 L224 224 L224 192 L140 144 Z",
            },
            pressed: {
              d: "M224 128 L196 144 L196 128 L224 112 ZM224 128 L308 176 L308 160 L224 112 ZM224 128 L168 160 L168 144 L224 112 ZM224 128 L252 144 L252 128 L224 112 ZM196 144 L168 160 L168 144 L196 128 ZM196 144 L280 192 L280 176 L196 128 ZM224 192 L168 224 L168 208 L224 176 ZM224 192 L252 208 L252 192 L224 176 ZM140 176 L112 192 L112 176 L140 160 ZM140 176 L224 224 L224 208 L140 160 Z",
            },
          }}
          transition={transition}
        />
        ...
        <motion.path
          variants={{
            normal: {
              d: "M336 192 L252 240 L252 208 L336 160 ZM336 192 L364 208 L364 176 L336 160 ZM392 224 L308 272 L308 240 L392 192 ZM392 224 L420 240 L420 208 L392 192 ZM252 240 L224 256 L224 224 L252 208 ZM252 240 L336 288 L336 256 L252 208 Z",
            },
            pressed: {
              d: "M336 192 L252 240 L252 224 L336 176 ZM336 192 L364 208 L364 192 L336 176 ZM392 224 L308 272 L308 256 L392 208 ZM392 224 L420 240 L420 224 L392 208 ZM252 240 L224 256 L224 240 L252 224 ZM252 240 L336 288 L336 272 L252 224 Z",
            },
          }}
          transition={transition}
        />
