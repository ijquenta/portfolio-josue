...
export function Overview() {
  ...
  return (
    <Panel className="after:content-none">
      <h2 className="sr-only">{t("section.overview")}</h2>
      ...
      <PanelContent className="grid gap-x-4 gap-y-2.5 sm:grid-cols-2">
        ...
        <IntroItem>
          ...
          <IntroItemContent>
            <IntroItemLink
              ...
              aria-label={`${t("label.location")}: ${USER.address}`}
            >
              {USER.address}
            </IntroItemLink>
          </IntroItemContent>
        ...
        <IntroItem>
          ...
          <IntroItemContent>
            <IntroItemLink
              href={USER.website}
              aria-label={`${t("label.website")}: ${urlToName(USER.website)}`}
            >
        ...
        <IntroItem>
          ...
          <IntroItemContent aria-label={`${t("label.pronouns")}: ${USER.pronouns}`}>
            {USER.pronouns}
          </IntroItemContent>
        </IntroItem>
      </PanelContent>
